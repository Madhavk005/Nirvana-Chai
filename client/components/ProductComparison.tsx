  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 bg-sage-600 hover:bg-sage-700 text-white p-4 rounded-full shadow-lg z-30 flex items-center gap-2"
      >
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-200">
                <div className="flex items-center gap-3">
                  <GitCompare className="h-6 w-6 text-sage-600" />
                  <h2 className="text-xl md:text-2xl font-bold text-gray-900">
                    {getLocalizedText("compare")}
                  </h2>
                  <span className="bg-sage-100 text-sage-700 text-sm px-3 py-1 rounded-full font-medium">
                      ...
                      >
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-1">
                            <div className="font-bold text-sage-700">
                          ...
                          <div className="space-y-2 pt-2">
                            <Link
                              ...
                              onClick={() => setIsOpen(false)}
                              className="w-full bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 px-3 rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-1"
                            >
                              {getLocalizedText("view-details")}
                            </Link>
                            <button
                              onClick={() => handleAddToCart(product)}
                              className="w-full bg-sage-600 hover:bg-sage-700 text-white py-2 px-3 rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-1"
                            >
